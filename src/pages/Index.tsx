  ...
  return (
    <div className="min-h-screen">
      ...
      <main>
            ...
            <div className="text-center max-w-3xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in" style={{ animationDelay: "300ms" }}>
                ...
                <a href="tel:+436645477490">
                  <Button size="lg" variant="outline" className="border-primary text-primary hover:bg-primary hover:text-primary-foreground font-semibold rounded-full px-8 py-6 text-base w-full">
        ...
        <section className="section-padding bg-secondary/30" id="zielgruppen">
          ...
          <div className="container-narrow mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6 md:gap-8">
              {services.map((service, index) => (
                <Card key={service.title} className="group bg-card border-border hover:border-accent/50 card-hover">
                  <CardContent className="p-8">
                    <div className="flex items-center justify-center w-14 h-14 bg-accent/10 rounded-2xl mb-6 group-hover:bg-accent/20 transition-colors">
        ...
        {/* Über mich */}
        <section className="section-padding bg-secondary" id="ueber-mich">
          <div className="container-narrow mx-auto">
            <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
              <div>
                ...
                <p className="text-accent font-medium mb-6">Demenzexpertin & Trainerin</p>
                <blockquote className="font-display text-xl italic text-primary mb-6 border-l-4 border-accent pl-4">
                  „Ich übersetze Demenz"
                </blockquote>
                ...
                <div className="flex flex-wrap gap-3 mb-8">
                  {["Dipl. Gesundheits- und Krankenpflegerin", "Demenztrainerin", "Buchautorin"].map((tag) => (
                    <span key={tag} className="bg-accent/10 text-accent text-sm font-medium px-3 py-1.5 rounded-full">
                      {tag}
                    </span>
                  ))}
                </div>
              ...
              <div className="flex justify-center">
                <div className="relative">
                  <div className="w-64 h-64 md:w-80 md:h-80 rounded-3xl bg-gradient-to-br from-accent/20 to-primary/10 flex items-center justify-center">
        ...
        {/* Gratis PDF */}
        <section className="section-padding bg-gold-light" id="ressourcen">
          <div className="container-narrow mx-auto">
        ...
        {/* CTA */}
        <section className="section-padding bg-primary text-primary-foreground" id="kontakt">
