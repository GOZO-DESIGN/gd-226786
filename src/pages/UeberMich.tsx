...
const UeberMich = () => {
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container-narrow mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="font-display text-4xl md:text-5xl font-bold text-primary mb-2 leading-tight">
                Radka Eder
              </h1>
              <p className="text-accent font-semibold text-lg mb-6">Demenzexpertin & Trainerin</p>
              <div className="bg-secondary/50 rounded-xl px-6 py-3 mb-6 inline-block">
            ...
            <div className="flex justify-center">
              <Avatar className="w-48 h-48 border-4 border-accent/30">
        ...
        <div className="container-narrow mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {qualifications.slice(0, 3).map((q) => (
              <Card key={q.title} className="bg-background border-border">
                <CardContent className="p-6">
                  <div className="flex items-center justify-center w-12 h-12 bg-accent/10 rounded-xl mb-4">
      ...
      <section className="section-padding">
        <div className="container-narrow mx-auto">
          <Card className="max-w-3xl mx-auto bg-gradient-to-r from-accent/5 to-primary/5 border-accent/20 overflow-hidden">
            <CardContent className="p-8 md:p-10 grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="flex justify-center">
                <div className="w-40 h-52 bg-gradient-to-br from-accent/20 to-primary/10 rounded-xl flex items-center justify-center">
      ...
      <section className="section-padding bg-secondary/30">
        <div className="container-narrow mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-3xl mx-auto text-center">
            {approach.map((a) => (
              <div key={a.title}>
                <div className="flex items-center justify-center w-14 h-14 bg-accent/10 rounded-full mb-4 mx-auto">
